...
curve_name = 'ita_param_Custom3.raw';
...
%     end
    ...
    if transform_open == 1
        ...
        fid = fopen([[path '/Custom3'] '/' curve_name], 'w');  
        ...
        [a b c ] = xlsread('Y16记录表_定制范围3.xls');      
        m_data = a(1:2,2:8);        
%         m_data = cellfun(@str2num,m_data);
        ...
        %-10℃环温对应曲线     
        Data_10(1:6,1)=[70	90	150	200	300	400];    %High  
        Data_10(1:6,2)=(m_data(1,2:7))';
        Data_10(:,2) =  Data_10(:,2) - Data_10(2,2) + 1000;
        nCurve(5,:) = Curve_High(Data_10);
%       plot( nCurve(2,:))
         %0℃环温对应曲线     
        Data_0(1:6,1)=[70	90	150	200	300	400];    %High  
        Data_0(1:6,2)=(m_data(2,2:7))';   

...
%     figure(2);
%     for i = 1:usFocusArrayLength/2
%         plot (1:4300,curve_data_distance05(i,:));hold on ;
%     end
...
%             usFocusArray(5), 6500];    % 焦温数组
        ...
        %3℃环温对应曲线     
        Data_3(1:9,1)=[70	90	110	150	200	250	300	350	400];    %High  
        Data_3(1:9,2)=(m_data(1,2:10))';
        Data_3(:,2) =  Data_3(:,2) - Data_3(2,2) + 1000;
        nCurve(2,:) = Curve_High(Data_3);
%       plot( nCurve(2,:))
         %13℃环温对应曲线     
        Data_13(1:9,1)=[70	90	110	150	200	250	300	350	400];    %High  
        Data_13(1:9,2)=(m_data(2,2:10))';   
        Data_13(:,2) =  Data_13(:,2) - Data_13(2,2) + 1000;
        nCurve(3,:) = Curve_High(Data_13);
        
        %23℃环温对应曲线
        Data_23(1:9,1)=[70	90	110	150	200	250	300	350	400];
        Data_23(1:9,2)=(m_data(3,2:10))';
        Data_23(:,2) =  Data_23(:,2) - Data_23(2,2) + 1000;
        nCurve(4,:) = Curve_High(Data_23);
        
        %33℃环温对应曲线
        Data_33(1:9,1)=[70	90	110	150	200	250	300	350	400];
        Data_33(1:9,2)=(m_data(4,2:10))'; 
        Data_33(:,2) =  Data_33(:,2) - Data_33(2,2) + 1000;
        nCurve(5,:) = Curve_High(Data_33);

          %43℃环温对应曲线
%         Data_43(1:8,1)=[70	90	110	150	200	250	350	400];
%         Data_43(1:6,2)=(m_data(5,2:7))';  Data_43(7:8,2)=(m_data(5,9:10))';
%         Data_43(:,2) =  Data_43(:,2) - Data_43(2,2) + 1000;
%         nCurve(6,:) = Curve_High(Data_43);
        
        Data_43(1:9,1)=[70	90	110	150	200	250	300	350	400];
        Data_43(1:9,2)=(m_data(5,2:10))';
        Data_43(:,2) =  Data_43(:,2) - Data_43(2,2) + 1000;
        nCurve(6,:) = Curve_High(Data_43);
